...
Implementation-level decisions made by CXP-00 through CXP-14, including the later GMT-extraction clarification, are recorded in the [decision log](decision-log.md). CXP-14 repository decisions through DEC-074 remain implemented locally. DEC-070 through DEC-074 are the CXP-13/CXP-14 timeout, semantic-verification, authoritative-evidence, preparation-audit, and surgical hot-path patches that require fresh hosted expected-peak evidence.
