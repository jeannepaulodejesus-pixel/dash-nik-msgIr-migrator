...
- **Hosted UAT:** Pending. Follow `docs/cxp06-uat-runbook.md` using a non-production workbook before promotion; local tests do not prove hosted quotas, execution time, abrupt termination recovery, or reader isolation.
