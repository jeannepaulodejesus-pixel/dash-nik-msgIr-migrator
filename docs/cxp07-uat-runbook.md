...
4. Replace the raw values with a second valid bundle without reinstalling formulas, flush, and confirm the calculation outputs refresh (`cxp07UatStep3SecondBundleRefresh`).
